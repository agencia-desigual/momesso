...
// URL base do site.
defined('BASE_URL') OR define('BASE_URL', 'http://192.168.0.227/git/momesso/');

// URL base do storange
defined('BASE_STORANGE') OR define('BASE_STORANGE', 'http://192.168.0.227/git/momesso/storage/');
