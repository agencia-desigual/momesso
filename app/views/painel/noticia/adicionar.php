                            ...
                            <div class="row">
                                <div1 class="col-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" class="form-control form-control-alternative" id="campoNome" name="nome" placeholder="Título da notícia" required />
                                    </div>
                                </div1>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group focused">
                                        ...
                                        <textarea class="form-control form-control-alternative" rows="2" name="palavras_chave" required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group focused">
                                        ...
                                        <textarea class="form-control form-control-alternative" rows="5" name="resumo" required></textarea>
                                    </div>
                                </div>
                            </div>
